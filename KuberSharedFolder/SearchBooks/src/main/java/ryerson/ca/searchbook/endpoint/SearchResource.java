...
public class SearchResource {
    ...
    public String getXml(@PathParam("query") String query) {
        ...
        BooksXML books;
        try {
            books = search.getBooksByQuery(query);
    ...
    /*
    The following methos is just for test. Please delete it
    */
    
    @GET
    @Path("add")
    @Produces(MediaType.TEXT_HTML + ";charset=utf-8")
    public String add(@PathParam("query") String query) {
        try {
            Book_CRUD.addBook("111-111-111", "233-", "Anne of Green Gables");
